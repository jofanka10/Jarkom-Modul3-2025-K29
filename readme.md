...
### Config Worker (Elendil, Isildur, Anarion)
`nano /etc/nginx/sites-available/laravel`
```
server {
    listen 8001 default_server; # Port Elendil
...
### Uji Coba di Client
Kita pastikan nameservernya sudah benar di `/etc/resolv.conf`.
```
echo "nameserver 10.78.3.3" > /etc/resolv.conf
```

Untuk kode pengetesannya seperti ini.
```
# Tes halaman utama
...
<img width="935" height="394" alt="image" src="https://github.com/user-attachments/assets/0c8f7dba-3c6a-4125-b8d3-df889105567a" />
